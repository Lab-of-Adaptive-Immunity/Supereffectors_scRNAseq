...
cowplot::plot_grid(DimPlot(E07_W3_510_data, group.by = "Immgen_annot_main"), 
...
seu_wocc <- FindVariableFeatures(seu_wocc, selection.method = "vst", nfeatures = 500,verbose = FALSE)
